...
SHAKEs, and cSHAKE and KMAC from SP 800-185 — have been built on top of it.
The ML-KEM /
...
| PBKDF2, one iteration, 32-byte output | 5.1 billion | 6.8 s |
...
the sponge, SHA3-224/256/384/512, both SHAKEs, and cSHAKE and KMAC at both
rates — so what sat behind it is now reachable:
