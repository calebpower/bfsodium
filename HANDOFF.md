...
The suite is **336 pass, 0 fail**. The v1 set CONVENTIONS section 9 asks for is
...
| `chacha20/add32` | 617 | 166 | boundary vectors + Cryptol |
...
| `chacha20/rotl32` | 608 | 155 | boundary vectors + Cryptol |
| `chacha20/xor32` | 125 | 190 | boundary vectors + Cryptol |
| `chacha20/stagger` | 224 | 253 | Cryptol |
| `chacha20/rowrot` | 246 | 306 | Cryptol |
| `chacha20/qrloop` | 1520 | 351 | RFC 8439 §2.2.1 |
| `chacha20/blockloop` | 4545 | 1252 | RFC 8439 §2.3.2 |
| `chacha20/blockkeep` | 5232 | 341 | RFC 8439 §2.3.2 + its input surviving |
| `chacha20/stream` | 6493 | 711 | RFC 8439 §2.4.2 + block edges |
| `poly1305/add136` | 2512 | 542 | boundary vectors + Cryptol |
| `poly1305/halve136` | 470 | 539 | boundary vectors + Cryptol |
| `poly1305/fold136` | 2533 | 97 | boundary vectors + Cryptol |
| `poly1305/dbl136` | 609 | 763 | boundary vectors + Cryptol |
| `poly1305/reducep136` | 5353 | 375 | boundary vectors + Cryptol + a proof |
| `poly1305/mulmod136` | 18337 | 841 | boundary vectors + Cryptol |
| `poly1305/clamp` | 248 | 299 | boundary vectors + Cryptol  the mask pinned both ways |
| `poly1305/absorb` | 20848 | 127 | boundary vectors + Cryptol + folds to the RFC tag |
| `poly1305/poly1305` | 25238 | 935 | RFC 8439 §2.5.2 + block edges |
| `aead/keygen` | 4544 | 44 | RFC 8439 §2.6.2 + A.4 vectors 1 and 2 |
| `sha256/round` | 8039 | 1158 | seven vectors + Cryptol |
| `sha256/expand` | 3268 | 475 | seven vectors + Cryptol |
| `sha256/hashcore` | 26051 | 1635 | one message from memory, the wire, and both |
| `sha256/sha256` | 26017 | 60 | FIPS 180-4 + both padding boundaries |
| `sha256/hmac` | 103534 | 1666 | RFC 4231 cases 1, 2, 3 and 6 |
| `sha256/hkdf` | 291976 | 512 | RFC 5869 A.1, A.2 and A.3 |
| `aead/chacha20poly1305` | 78481 | 1533 | RFC 8439 §2.8.2 + both block edges + metamorphic |
...
| `bftable.pl` | does this document's routine table still describe the tree |
